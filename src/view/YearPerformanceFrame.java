...
public class YearPerformanceFrame extends JFrame {
    Font font=new Font("宋体",Font.PLAIN,16);
    private JLabel[] text = {new JLabel("本年租房成交量:"),
            new JLabel("本年卖房成交额:"),
            new JLabel("本年卖房成交量:"),
            new JLabel("本年卖房成交额:")
    };
    ...
    public YearPerformanceFrame(String admin) throws Exception {
        setTitle(admin+"的年绩");
        setLayout(null);
        setSize(350,250);
    ...
    private void queryYear(String admin) {
        try {
            houses = HouseDao.queryYear(admin);
        } catch (Exception e) {
            e.printStackTrace();
        }
